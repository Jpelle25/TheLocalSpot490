...
INSERT INTO "EVENTS" (ID, VERSION, COORD_ID, EVENT_STATUS, EVENT_GENRES, EVENT_NAME, EVENT_TIME, DATE_START, DATE_END, EVENT_CAPACITY, EVENT_INFO, MAX_TICKETS, AVAILABLE_TICKETS, TICKET_PRICE, HOST_ID, PLACE_ID) VALUES
...
(3, 1, 1, 'TRUE', 'Theatre', 'eventC', '14:00', '2023-12-30', '2023-12-31', '100', 'This is the info for event C', '100', '100', '5.00', 2, 3),
(4, 1, 1, 'FALSE', 'Gaming', 'eventD', '15:00', '2023-12-30', '2023-12-31', '100', 'This is the info for event D', '100', '100', '5.00', 2, 3),
(5, 1, 1, 'FALSE', 'Sports', 'eventE', '16:00', '2023-12-30', '2023-12-31', '100', 'This is the info for event E', '100', '100', '5.00', 3, 4);