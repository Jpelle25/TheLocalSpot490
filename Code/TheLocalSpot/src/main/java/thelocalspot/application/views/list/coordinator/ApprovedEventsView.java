...
@Route(value = "coordinator-approved-events", layout = CoordinatorMainLayout.class)
@PermitAll
public class ApprovedEventsView extends VerticalLayout {
    private final CoordUserService coordUserService;
    private final EventService eventService;
    Grid<Event> grid;

    public ApprovedEventsView(CoordUserService coordUserService, EventService eventService) {
